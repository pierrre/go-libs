...
// The caller must call the returned [Waiter] to wait for the goroutine to finish.
...
// The caller must call the returned [Waiter] to cancel and wait for the goroutine to finish.
